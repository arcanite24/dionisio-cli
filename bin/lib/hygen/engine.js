...
var engine = function (argv, config) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (_a = Object).assign;
                return [4 /*yield*/, params(config, argv)];
            case 1:
                ...
                return [4 /*yield*/, fs.exists(actionfolder)];
            case 2:
            ...
            case 3: return [4 /*yield*/, _c.apply(void 0, [_d.sent(), args, config])];
