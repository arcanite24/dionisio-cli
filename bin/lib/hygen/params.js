...
var params = function (_a, externalArgv) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var argv, _b, generator, action, name, _c, mainAction, subaction, actionfolder, promptArgs, args;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    argv = yargs(externalArgv);
                    _b = argv._, generator = _b[0], action = _b[1], name = _b[2];
                    if (!generator || !action) {
                        return [2 /*return*/, { generator: generator, action: action, templates: templates }];
                    }
                    _c = L.split(action, ':'), mainAction = _c[0], subaction = _c[1];
                    actionfolder = path.join(templates, generator, mainAction);
                    return [4 /*yield*/, prompt(createPrompter, actionfolder, L.omit(argv, ['_']))];
                case 1:
                    promptArgs = _d.sent();
                    args = Object.assign({
                        templates: templates,
                        ...
                        action: action,
                        subaction: subaction
                    }, promptArgs, L.omit(argv, ['_']), name && { name: name });
